...
void SortedMergeRecur(Node*& xHead, Node*& yHead, Node*& zHead)
{
    ...
    if(xHead != NULL && yHead == NULL)  // xhead is not empty but yhead is
    {
        if(zHead == 0)
        {
            zHead = xHead;
    ...
    if(xHead == NULL && yHead != NULL)  //xhead is empty and yhead is not
    {
        if(zHead == 0)
        {
            zHead = yHead;
    ...
    else if(xHead != NULL && yHead != NULL)  //neither are empty
    {
        if(zHead == 0)
        {
