...
int HiIndexMinNeg(const int aName[], int size);
...

{
    ...
    int minIndexTheRest = HiIndexMinNeg(a+1, n - 1);
    if (a[0] < a[minIndexTheRest + 1])
    {
        if(a[0] < 0 )
        {
            return 0;
    ...
    else if (a[0] == a[minIndexTheRest +1])
    {
        if(a[minIndexTheRest+1] < 0)
        {
    ...
    {
        if(minIndexTheRest == -999)
        {
            return -999;
        }
        else
        {
            return minIndexTheRest+1;
        }
    }
}
